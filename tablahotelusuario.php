...
$sql1= "select * from hoteles where idusers = ".$ses;
...
<tr>
	...
	<td style="width:250px;">
		<a href="./editarhotelusuario.php?id=<?php echo $r["id"];?>" class="btn btn-sm btn-success glyphicon glyphicon-pencil">  EDITAR</a>
		...
		$("#del-"+<?php echo $r["id"];?>).click(function(e){
			...
			if(p){
				window.location="./eliminarhotelusuario.php?id="+<?php echo $r["id"];?>;
