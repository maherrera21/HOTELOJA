...
if( !isset($_SESSION['user']) ) {
 ...
 if ( isset($_POST['btn-signup']) ) {
  ...
  if( !$error ) {
   ...
   $query = "INSERT INTO lugares(lugNom,lugDes,id) VALUES('$nombre','$descripcion','$hotel')";
   $res = mysql_query($query);

    
   if ($res) {
    $errTyp = "éxito";
    $errMSG = "Lugar turístico Registrado Correctamente";
   } else {
    $errTyp = "peligro";
 ...
 <div id="login-form">
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
     ...
     <div class="col-md-6 col-md-offset-3">
         ...
         <div class="form-group">
             <h2 class="">Agregar Nuevo Lugar Turístico</h2>
            </div>
   ...
   ?>
            <div class="form-group">
             ...
             <input type="text" name="nombre" class="form-control" placeholder="Ingrese nombre del lugar" maxlength="100" />
                </div>
            ...
            <div class="form-group">
             <div class="input-group">
                <span class="input-group-addon"><span class="glyphicon glyphicon-edit"></span></span>
             <input type="text" name="descripcion" class="form-control" placeholder="Ingrese descripción del lugar" maxlength="100" />
                </div>
