...
if( !isset($_SESSION['user']) ) {
 ...
 if ( isset($_POST['btn-signup']) ) {
  ...
  if( !$error ) {
   ...
   $query = "INSERT INTO servicios(serDes,id) VALUES('$descripcion','$hotel')";
 ...
 <div id="login-form">
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
     ...
     <div class="col-md-6 col-md-offset-3">
         ...
         <div class="form-group">
             <h2 class="">Agregar Nuevo Servicio</h2>
            </div>
   ...
   ?>
            ...
            <div class="form-group">
             ...
             <input type="text" name="descripcion" class="form-control" placeholder="Ingrese descripción de servicio" maxlength="100" />
                </div>
